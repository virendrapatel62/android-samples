...
//                openLoginScreen();
                ...
                Uri.Builder builder = Uri.parse(API.REGISTER_STUDENT).buildUpon();
                builder.appendQueryParameter("name" , nm);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, builder.toString(), new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.equalsIgnoreCase("false")){
                            Toast.makeText(StudentRegistration.this, "Email Exixts", Toast.LENGTH_SHORT).show();
